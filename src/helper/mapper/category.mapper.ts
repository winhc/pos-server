...
export const toCategoryModel = (data: Category): CategoryModel => {
    const { id, category_code, category_name, image, remarks, created_at, updated_at, products } = data;
    const categoryModel: CategoryModel = { id, category_code, category_name, image, remarks, created_at, updated_at, products };
